<section id="services" class="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20">
	<h2 class="text-3xl font-semibold md:text-4xl">Services</h2>
	<p class="mt-2 text-sm text-muted-foreground md:text-base">What I build for your business</p>
